...
public class barcodeScannerActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler{
    ...
    public void handleResult(Result result) {
        ...
        String label="Press OK to confirm \nor cancel to leave";
        final customDialog alert=new customDialog(this);
        alert.setDialogType("success");
        alert.setMessage(label);
        alert.setNegativeButton("Cancel","#1FA321", new View.OnClickListener() {
            @Override
        ...
        alert.setPositiveButton("Ok","#1FA321", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                alert.cancel();
            }
